...
namespace DTR
{
	class TargetReticle : public TRUEHUD_API::WidgetBase
	{
	public:
		...
		TargetReticle(uint32_t a_widgetID, RE::ObjectRefHandle a_refHandle, RE::NiPointer<RE::NiAVObject> a_targetPoint) :
